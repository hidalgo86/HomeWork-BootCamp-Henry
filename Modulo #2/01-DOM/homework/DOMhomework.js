...
// Tu código acá:
 let diseñador = document.querySelector("#createdBy")

diseñador.innerHTML = 'Aplicacion creada por Eduardo'
...
// array.map(e => toDoContainer.appendChild(e))
}
...
function addToDo() {
  // Tu código acá:
  let toDoImp = document.querySelector('#toDoInput').value;
  let newTodo = new ToDo (toDoImp)
